  ...
  return (
    <Container className="py-4">
      <div className="mb-4">
        ...
        {workspace.is_default && <Badge bg="success">Default Workspace</Badge>}
      </div>
      ...
      <Row>
          ...
          <Card className="mb-4">
            <Card.Header>
              <div className="d-flex justify-content-between align-items-center">
                <h4 className="mb-0">
                  Categories in this Workspace ({workspace.categories.length})
                </h4>
                <Button
            ...
            <Card.Body>
              {workspace.categories.length === 0 ? (
                <p className="text-muted">
                  No categories in this workspace yet.
                </p>
              ) : (
                    ...
                    >
                      ...
                      <Dropdown align="end">
                        ...
                        <Dropdown.Menu>
                          ...
                          <Dropdown.Item
                            onClick={() =>
                              removeCategoryFromWorkspace(category.id)
                            }
        ...
        <Col md={4}>
          <Card>
            ...
            <Card.Body>
              <p>
                <strong>Categories:</strong> {workspace.categories.length}
              </p>
              <p>
      ...
      >
        ...
        <Modal.Body>
          ...
          {availableCategories.length === 0 ? (
            <Alert variant="info">
              All available categories are already in this workspace.
            </Alert>
          ) : (
            <Form>
